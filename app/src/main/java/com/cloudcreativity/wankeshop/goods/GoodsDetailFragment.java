...
public class GoodsDetailFragment extends LazyFragment {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        FragmentGoodsDetailBinding binding = DataBindingUtil.inflate(inflater, R.layout.fragment_goods_detail,container,false);
        binding.wvGoodsDetail.loadUrl("file:///android_asset/detail.html");
