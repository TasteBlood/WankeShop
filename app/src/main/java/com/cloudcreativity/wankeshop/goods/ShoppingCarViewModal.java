...
/**
 * 这是ShoppingCarActivity ViewModal
 */
public class ShoppingCarViewModal {
    ...
    private ShoppingCarViewModal.MyHandler handler = new ShoppingCarViewModal.MyHandler();
    ...
    ShoppingCarViewModal(ActivityShoppingcarBinding binding, BaseDialogImpl baseDialog, Context context) {
        ...
        isEdit.set(false);
        hasItems.set(true);
        binding.refreshShoppingCar.setOnRefreshListener(refreshListenerAdapter);
    ...
    private void changePrice(final boolean isChecked, final ShopCarItemEntity entity) {
        if(isChecked){
            ...
            new Thread(){
                ...
                public void run() {
                    ...
                    if(price==(final_total_price+entity.getNum()*Float.parseFloat(entity.getSku().getSalePrice()))){
                        ...
                        msg.what = ShoppingCarViewModal.MyHandler.MSG_ALL_CHECK;
                        ...
                        Message msg = Message.obtain();
                        msg.what = ShoppingCarViewModal.MyHandler.MSG_PLUS_PRICE;
                        Bundle bundle = new Bundle();
            ...
            //减少价格
            Message msg = Message.obtain();
            msg.what = ShoppingCarViewModal.MyHandler.MSG_MINUS_PRICE;
            Bundle bundle = new Bundle();
            bundle.putFloat("total_price",entity.getNum()*Float.parseFloat(entity.getSku().getSalePrice()));
            bundle.putInt("number",entity.getNum());
            msg.setData(bundle);
                ...
                .subscribe(new DefaultObserver<String>(baseDialog,false) {
                    ...
                    public void onSuccess(String t) {
                        ...
                        if(entities==null||entities.isEmpty()){
                            ...
                            ShoppingCarViewModal.this.pageNum++;
                        }
                    }
        ...
        public void handleMessage(Message msg) {
            ...
            switch (msg.what){
                ...
                case MSG_REFRESH_PRICE:
                    ShoppingCarViewModal.this.adapter.notifyDataSetChanged();
