...
public class ShopEntity implements Serializable{
    ...
    public void setStores(StoresEntity stores) {
        this.stores = stores;
    }
    ...
    public String getTaxesPic() {
        return taxesPic;
    }

    public void setTaxesPic(String taxesPic) {
        this.taxesPic = taxesPic;
    }
